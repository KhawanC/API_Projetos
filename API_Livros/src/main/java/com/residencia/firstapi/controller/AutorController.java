...
public class AutorController {
	...
	public Autor findByAutorNome(@PathVariable(value = "autorNome") String nomeAutor) {
		return autorService.findByAutorNome(nomeAutor);
	}

	@GetMapping("/iniciaCom/{stringQualquer}")
	public List<Autor> findByAutorNomeStartsWith(@PathVariable(value = "stringQualquer") String qualquerString) {
		return autorService.findByAutorNomeStartsWith(qualquerString);
	}
